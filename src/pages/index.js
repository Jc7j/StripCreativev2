  ...
  <div id="main">
    ...
    <header className="hero">
      <div id="container">
        ...
        <p className="smallT">
        Every business deserves a unique and powerful online presence. Our mission is to transform your vision into a stunning, functional website that not only meets but exceeds yours and your customers expectations.
    ...
    <section className="about">
      <div id="container">
        ...
        <div className="txt mT2">
          <h5>
            Innovise stands at the forefront of digital product agencies,
            specializing in branding, user interface and user experience design,
            alongside mobile and web development.
          </h5>
        </div>
    ...
    <section className="work">
      <div id="container">
        <div className="heading_cnt">
          ...
          <a href="works.html" className="btn focus" data-magnetic="">
            <span>View All</span>
          </a>
        </div>
        <div className="wrapper mT5">
          <div className="col">
            <div className="card">
              ...
              <div className="details mT3">
                <h2>kodam</h2>
                <p>UIUX Design, Web Development</p>
                <a
                  className="btn focus mT2"
                  data-magnetic=""
                  href="https://dribbble.com/shots/23682713-KODAM-Creative-Agency-Website"
                  target="_blank"
                >
            ...
            <div className="card">
              ...
              <div className="details mT3">
                ...
                <a
                  className="btn focus mT2"
                  data-magnetic=""
                  href="https://dribbble.com/shots/23655060-Sigen-Branding-Part-B"
                  target="_blank"
                >
                  <span>View Project</span>
                </a>
            ...
            <div className="card">
              ...
              <div className="details mT3">
                <h2>VPN App</h2>
                <p>UIUX Design, Wireframe, App Development</p>
                <a
                  className="btn focus mT2"
                  data-magnetic=""
                  href="https://dribbble.com/shots/23725863-VPN-Mobile-App-Design"
                  target="_blank"
                >
                  <span>View Project</span>
                </a>
          ...
          <div className="col">
            <div className="card">
              ...
              <div className="details mT3">
                <h2>Dalius</h2>
                <p>Branding, Graphics Design</p>
                <a
                  className="btn focus mT2"
                  data-magnetic=""
                  href="https://dribbble.com/shots/20574894-Gradient-Logo-Design-Whimble"
                  target="_blank"
                >
                  <span>View Project</span>
                </a>
            ...
            <div className="card">
              ...
              <div className="details mT3">
                <h2>Pueblo</h2>
                <p>UIUX Design, Illustration</p>
                <a
                  className="btn focus mT2"
                  data-magnetic=""
                  href="https://dribbble.com/shots/23654514-Crackers-Package-Design"
                  target="_blank"
                >
                  <span>View Project</span>
                </a>
    ...
    <section className="clients">
      <div id="container">
        ...
        <div className="wrapper mT5">
          <h3>
            google/ microsoft / amazon / apple / gucci / rayban / microsoft /
            dribble / facebook / levis / outfitters / tesla / IBA / verizon /
            tiktok / lenskart / reliance
          </h3>
        </div>
      </div>
      {/* Swiper */}
        ...
        <div className="swiper-wrapper focus">
          <div className="swiper-slide">
            <div className="top">
              <h2>&quot;</h2>
              <p>
                Collaborating with the team at Innovise has been a game-changer
                for our startup. From conceptualizing our branding to the
                seamless execution of our website and mobile app, their
                expertise in UI/UX has not only elevated our online presence but
          ...
          <div className="swiper-slide">
            <div className="top">
              <h2>&quot;</h2>
              <p>
                When we approached Innovise, our e-commerce platform was in dire
                need of a facelift. Their team took on the challenge with
                enthusiasm and professionalism, delivering a comprehensive
                redesign that has not only improved our brand&apos;s image but also
                our sales metrics.
              </p>
            </div>
            <div className="bottom">
          ...
          <div className="swiper-slide">
            <div className="top">
              <h2>&quot;</h2>
              <p>
                Our non-profit&apos;s mission is to reach and engage with as many
                people as possible, but our outdated website was hindering our
                efforts. From the outset, Innovise understood the importance of
                our work and the need for a robust digital platform.
              </p>
            </div>
            <div className="bottom">
              <h5>Julia Bale</h5>
      ...
      <div className="marquee">
        ...
        <div id="marquee-container-reverse" className="marquee-container">
          <h1 className="marquee-text-reverse">
            Let&apos;s scroll — Let&apos;s scroll — Let&apos;s scroll — Let&apos;s scroll — Let&apos;s
            scroll — Let&apos;s scroll — Let&apos;s scroll —
          </h1>
          <h1 className="marquee-text-reverse">
            Let&apos;s scroll — Let&apos;s scroll — Let&apos;s scroll — Let&apos;s scroll — Let&apos;s
            scroll — Let&apos;s scroll — Let&apos;s scroll —
    ...
    <footer>
      <div id="container">
        ...
        <div className="copyrights mT2">
          <p>©2024 Innovise</p>
          <p>
            All Images are used from Behannce, Dribble by thier own creators.
          </p>
        </div>
      </div>
